...
import com.thechance.whatschance.domain.usecases.CheckSmsCodeUseCase
...
class VerificationViewModel @Inject constructor(
    ...
    val checkSmsCode: CheckSmsCodeUseCase
) : ViewModel() {

    private val args = VerificationFragmentArgs.fromSavedStateHandle(state)
